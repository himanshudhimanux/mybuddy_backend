...
//     // Step 3: Find sessions for selected date only
//     const sessions = await Session.find({
//       batchClassId: { $in: batchClassIds },
//       batchDate: { $gte: startOfDay, $lte: endOfDay }
//     })
