...
const { createSession, getSessions, getSessionById, updateSession, deleteSession, getSessionsByType,  getUpcomingSessions, getSessionsWithAttendance, getAllSessionByDate } = require('../controllers/sessionController');
