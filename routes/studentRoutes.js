...
const { studentRegister, getAllStudent, specificStudent, studentPicUpload, updateStudent, deleteStudent, fetchStudentsByPhone } = require('../controllers/studentController');
